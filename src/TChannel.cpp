...
std::ostringstream TChannel::GetJSONstring(void)
{
    ...
    //compose the string
    oj << "{\n\"name\": \"" << Js.DeviceName << "\",";
    oj<< "\n\""<< class_names[0] << "\": "<< CntAr[0] << ",";   //person
    oj<< "\n\""<< class_names[1] << "\": "<< CntAr[1] << ",";   //bicycle
    oj<< "\n\""<< class_names[2] << "\": "<< CntAr[2] << ",";   //car
    oj<< "\n\""<< class_names[3] << "\": "<< CntAr[3] << ",";   //motorbike
    oj<< "\n\""<< class_names[5] << "\": "<< CntAr[5] << ",";   //bus
    oj<< "\n\""<< class_names[7] << "\": "<< CntAr[7] << "\n}"; //truck
